namespace WpfInfoTerminal
{
    ...
    using WpfInfoTerminal.ViewModels;
    #endregion
    ...
    public class ServerConnection
    {
        ...
        private void ResolveServerMessage(byte[] Req)
        {
            ...
            if (RequestString.Equals("[ORDERDONE]") || RequestString.Equals("[ORDERBAKED]"))
            {
                OrderViewModel.Instance.GetReadyOrders();
            }
        ...
        private void ConnectCallback(IAsyncResult ar)
        {
            try 
            {
                ...
                Connection.Send(Encoding.Default.GetBytes("4"));
